package com.blueyonder.ecomm_service.security.jwt;
...
import com.blueyonder.ecomm_service.services.UserDetailsImpl;
...
public class JwtUtils {
  ...
  @Value("${ecomm_service.jwtSecret}")
  private String jwtSecret;

  @Value("${ecomm_service.jwtExpirationMs}")
